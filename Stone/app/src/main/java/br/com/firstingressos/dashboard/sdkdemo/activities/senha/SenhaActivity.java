package br.com.firstingressos.dashboard.sdkdemo.activities.senha;
...
public class SenhaActivity extends AppCompatActivity {
    ...
    public void voltar(View view){
        ...
        Intent intent = new Intent(SenhaActivity.this, PosTransactionActivity.class);
                ...
                mAuth.signInWithEmailAndPassword(email, pass)
                        .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                                ...
                                try{
                                    ...
                                    if (bundle != null) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(SenhaActivity.this, "Erro no bundle", Toast.LENGTH_SHORT).show();
                                        }


                                        for (int j = 0; j < nameList.size(); j++) {
                                            try {
                                                db.collection("promotores/" + finalEmail + "/vendas/").add(new Vendas(valorList.get(j), finalEmail, new SimpleDateFormat("dd/MM/yyyy - HH:mm:ss").format(Calendar.getInstance().getTime()), tipo, "Dinheiro", "0", nameList.get(j)));
                                            } catch (Exception e) {
                                                Toast.makeText(SenhaActivity.this, "Erro no Firebase", Toast.LENGTH_SHORT).show();
                                                db.collection("promotores/" + finalEmail + "/vendas/").add(new Vendas(valorList.get(j), finalEmail, new SimpleDateFormat("dd/MM/yyyy - HH:mm:ss").format(Calendar.getInstance().getTime()), tipo, "Dinheiro", "0", "Item"));
                                            }
                                        }
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(SenhaActivity.this, "Erro ao preparar impressão", Toast.LENGTH_SHORT).show();
                                        }

                                        Intent intent = new Intent(SenhaActivity.this, PagamentoRealizadoActivity.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                } catch (Exception e) {
                                    Toast.makeText(SenhaActivity.this, "Erro ao salvar dados", Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(SenhaActivity.this, "Erro ao confirmar identidade", Toast.LENGTH_SHORT).show();
                            }
                        });
            } else {
    ...
    public void ingressos(View view) throws IOException {
        try {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SenhaActivity.this, "Provider", Toast.LENGTH_SHORT).show();
                                PosPrintProvider customPosPrintProvider = new PosPrintProvider(SenhaActivity.this);
                                ...
                                customPosPrintProvider.setConnectionCallback(new StoneCallbackInterface() {
                                    ...
                                    public void onSuccess() {
                                        Toast.makeText(SenhaActivity.this, "Ingresso impresso", Toast.LENGTH_SHORT).show();
                                    }

                                    @Override
                                    public void onError() {
                                        Toast.makeText(SenhaActivity.this, "Erro ao imprimir: " + customPosPrintProvider.getListOfErrors(), Toast.LENGTH_SHORT).show();
                                    }
                                });
            ...
            Toast.makeText(SenhaActivity.this, "Erro ao imprimir", Toast.LENGTH_SHORT).show();
        }
    }
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            customPosPrintProvider.setConnectionCallback(new StoneCallbackInterface() {
                                @Override
                                public void onSuccess() {
                                    Toast.makeText(SenhaActivity.this, "Produto impresso", Toast.LENGTH_SHORT).show();
                                }
    ...
    public void pulseiras(View view) throws IOException {
        if(ip.getText().toString().isEmpty()){
            Toast.makeText(SenhaActivity.this, "Endereço IP inválido", Toast.LENGTH_SHORT).show();
            return;
        }

        if(port.getText().toString().isEmpty()){
            Toast.makeText(SenhaActivity.this, "Porta inválida", Toast.LENGTH_SHORT).show();
            return;
        }
